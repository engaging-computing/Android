...
public class MagFragment extends Fragment implements SensorEventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup rootView = (ViewGroup) inflater.inflate(
                R.layout.mag_fragment, container, false);

        x = (TextView) rootView.findViewById(R.id.magx);
        y = (TextView) rootView.findViewById(R.id.magy);
        z = (TextView) rootView.findViewById(R.id.magz);
